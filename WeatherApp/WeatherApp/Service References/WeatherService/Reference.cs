...
namespace WeatherApp.WeatherService {
    ...
    public interface WeatherSoap {
        ...
        WeatherApp.WeatherService.GetWeatherInformationResponse GetWeatherInformation(WeatherApp.WeatherService.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetWeatherInformation", ReplyAction="*")]
        System.Threading.Tasks.Task<WeatherApp.WeatherService.GetWeatherInformationResponse> GetWeatherInformationAsync(WeatherApp.WeatherService.GetWeatherInformationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        WeatherApp.WeatherService.ForecastReturn GetCityForecastByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityForecastByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<WeatherApp.WeatherService.ForecastReturn> GetCityForecastByZIPAsync(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        WeatherApp.WeatherService.WeatherReturn GetCityWeatherByZIP(string ZIP);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://ws.cdyne.com/WeatherWS/GetCityWeatherByZIP", ReplyAction="*")]
        System.Threading.Tasks.Task<WeatherApp.WeatherService.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP);
    }
    ...
    public partial class GetWeatherInformationResponse {
        ...
        public WeatherApp.WeatherService.WeatherDescription[] GetWeatherInformationResult;
        
        public GetWeatherInformationResponse() {
        }
        
        public GetWeatherInformationResponse(WeatherApp.WeatherService.WeatherDescription[] GetWeatherInformationResult) {
            this.GetWeatherInformationResult = GetWeatherInformationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface WeatherSoapChannel : WeatherApp.WeatherService.WeatherSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WeatherSoapClient : System.ServiceModel.ClientBase<WeatherApp.WeatherService.WeatherSoap>, WeatherApp.WeatherService.WeatherSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WeatherApp.WeatherService.GetWeatherInformationResponse WeatherApp.WeatherService.WeatherSoap.GetWeatherInformation(WeatherApp.WeatherService.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformation(request);
        }
        
        public WeatherApp.WeatherService.WeatherDescription[] GetWeatherInformation() {
            WeatherApp.WeatherService.GetWeatherInformationRequest inValue = new WeatherApp.WeatherService.GetWeatherInformationRequest();
            WeatherApp.WeatherService.GetWeatherInformationResponse retVal = ((WeatherApp.WeatherService.WeatherSoap)(this)).GetWeatherInformation(inValue);
            return retVal.GetWeatherInformationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<WeatherApp.WeatherService.GetWeatherInformationResponse> WeatherApp.WeatherService.WeatherSoap.GetWeatherInformationAsync(WeatherApp.WeatherService.GetWeatherInformationRequest request) {
            return base.Channel.GetWeatherInformationAsync(request);
        }
        
        public System.Threading.Tasks.Task<WeatherApp.WeatherService.GetWeatherInformationResponse> GetWeatherInformationAsync() {
            WeatherApp.WeatherService.GetWeatherInformationRequest inValue = new WeatherApp.WeatherService.GetWeatherInformationRequest();
            return ((WeatherApp.WeatherService.WeatherSoap)(this)).GetWeatherInformationAsync(inValue);
        }
        
        public WeatherApp.WeatherService.ForecastReturn GetCityForecastByZIP(string ZIP) {
            return base.Channel.GetCityForecastByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<WeatherApp.WeatherService.ForecastReturn> GetCityForecastByZIPAsync(string ZIP) {
            return base.Channel.GetCityForecastByZIPAsync(ZIP);
        }
        
        public WeatherApp.WeatherService.WeatherReturn GetCityWeatherByZIP(string ZIP) {
            return base.Channel.GetCityWeatherByZIP(ZIP);
        }
        
        public System.Threading.Tasks.Task<WeatherApp.WeatherService.WeatherReturn> GetCityWeatherByZIPAsync(string ZIP) {
